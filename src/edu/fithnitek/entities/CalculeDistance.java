...
public class CalculeDistance extends OffreCovoiturage {
    ...
    public static final double lat_depart = 74.4;
    public static final double lon_depart = 96.4;
    public static final double lat_arriver = -36.2;
    public static final double lon_arriver = 99.3;

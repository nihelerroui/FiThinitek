 ...
 */
   ...
   public OffreCovoiturage(){
    ...
    public OffreCovoiturage(int id, String matricule, String marque, Date dateD, String lieuD, String lieuA, boolean dispo, int ndPlace, int numTel, int idUsr, int idAvis, int idDemande) {
        this.id = id;
